...
export function MemoryGrid({
  ...
  async function handleDelete(id: string) {
    ...
    try {
      ...
      setDeleteError("No se pudo borrar el recuerdo.");
    } finally {
      setPendingId(null);
    }
  }
        ...
        {memories.map((m) => (
          ...
          >
            ...
            <button
              ...
              className="absolute right-2 top-2 hidden rounded-full bg-ink/70 p-1.5 text-card backdrop-blur-sm transition hover:bg-ink group-hover:flex disabled:opacity-40"
            >
